  ...
  return (
    <div className="mt-5 flex items-center justify-center gap-1">
      <button
        ...
        className="flex h-9 w-9 cursor-pointer items-center justify-center rounded-full border border-brand-light/30 text-text-secondary transition-colors hover:bg-brand-light/10 disabled:cursor-not-allowed disabled:opacity-35"
      >
      ...
      {pages.map((page) => {
        ...
        return (
          <button
            ...
            className={`h-9 min-w-9 cursor-pointer rounded-full border px-3 text-sm transition-colors ${
              active
